            ...
            <div class="card-body flex h-full flex-col justify-between gap-2">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                        <span class="flex items-center text-xs font-medium text-success-500"><i class="h-3 w-3"
                            stroke-width="3px" data-feather="arrow-up-right"></i>3.5%</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>$6050.00</td>
                        <td>
                        <span class="flex items-center text-xs font-medium text-danger-500"><i class="h-3 w-3"
                            stroke-width="3px" data-feather="arrow-down-left"></i>0.5%</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                        <span class="flex items-center text-xs font-medium text-success-500"><i class="h-3 w-3"
                            stroke-width="3px" data-feather="arrow-up-right"></i>1.5%</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        <div class="flex items-center gap-3">
                            <img src="./images/category5.png"
                            class="h-10 w-10 rounded-primary border border-slate-300 p-0.5 dark:border-slate-400"
                            alt="category" />
                            <div>
                        ...
                        <td>
                        <span class="flex items-center text-xs font-medium text-danger-500"><i class="h-3 w-3"
                            stroke-width="3px" data-feather="arrow-down-left"></i>2.0%</span>
                        </td>
                    </tr>
                    </tbody>
                </table>
