    ...
    <main class="container flex flex-grow items-start p-6">
        ...
        <div
          ...
          <div id="chat-sidebar"
            ...
            <div class="max-h-[calc(100vh-18rem)]  md:max-h-[calc(100vh-17rem)] overflow-auto" data-simplebar>
              <ul id="chat-list">
                ...
                <li class="group">
                  <a href="javascript:void(0);"
                    class="inline-flex w-full items-start justify-between bg-transparent px-4 py-4 transition-colors duration-150 hover:bg-slate-100 group-[.active]:bg-slate-100 dark:hover:bg-slate-700 group-[.active]:dark:bg-slate-700">
                    <div class="avatar avatar-circle avatar-warning avatar-indicator avatar-indicator-busy shrink-0">
          ...
          <div class="relative rounded-primary bg-white shadow dark:bg-slate-800 xl:col-span-4 2xl:col-span-3">
            ...
            <div class="relative max-h-[calc(100vh-18rem)]  md:max-h-[calc(100vh-17rem)]  overflow-auto px-4 pb-28"
              data-simplebar>
              <ul class="space-y-3">
                <!-- Friend Chat -->
                <li class="group">
