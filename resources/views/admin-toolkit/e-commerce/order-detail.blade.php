                  ...
                  <table class="table shadow-none">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="flex items-center gap-2">
                            <img src="{{ asset('images/product1.png') }}" class="h-12 w-12 rounded-primary" alt="product-img" />
                      ...
                      <tr>
                        <td>
                          <div class="flex items-center gap-2">
                            <img src="{{ asset('images/product2.png') }}" class="h-12 w-12 rounded-primary" alt="product-img" />
                            <div class="flex flex-col items-start justify-center">
                      ...
                      <tr>
                        <td>
                          <div class="flex items-center gap-2">
                            <img src="{{ asset('images/product3.png') }}" class="h-12 w-12 rounded-primary" alt="product-img" />
                            <div class="flex flex-col items-start justify-center">
